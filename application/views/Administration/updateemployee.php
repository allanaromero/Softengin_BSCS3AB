<div class="py-3 px-5" style="background-color: #1f2839; min-height: 90vh;">
    <div class="p-4" style="background-color: #f5f5ef; justify-content:center; min-height: 80vh;">
        <div class="btn-group">
            <a href="<?= base_url('employee/viewemployee') ?>">
        ...
        ?>
            ...
            <hr>
            <br>
            <form action="<?php echo base_url('employee/updateemployee') ?>" method="post">
                <!-- Hidden Employee ID -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="full_name" placeholder="" value="<?php echo $row->full_name; ?>" required>
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="department" placeholder="" value="<?php echo $row->department; ?>" required>
                    </div>
                </div>
                <br>
                <div class="row">
        ...
        ?>
        <div class="btn-group">
            <a href="<?= base_url(); ?>employee/changepasswordemployee/<?php echo $row->user_id; ?>">
                <button style="float: right; background-color: #b69d74; border: 5px; box-shadow: 2x 2px 5px dimgray;" class="px-3 py-2 m-1">
                    Change Password
                </button>
            </a>
